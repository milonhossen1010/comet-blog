  ...
  <body>
    ...
    <header id="topnav">
      <div class="container">
        ...
        <div class="logo">
          <a href="index-2.html">
            <img style="width: {{ $settings->logo_width }}" src="{{ asset('/') }}media/images/logo/{{ $logos->l_logo }}" alt="" class="logo-light">
            <img style="width: {{ $settings->logo_width }}" src="{{ asset('/') }}media/images/logo/{{ $logos->d_logo }}" alt="" class="logo-dark">
          </a>
        </div>
        <!-- End Logo container-->
    ...
    <section id="home">
      ...
      <div id="video-wrapper">
        <video autoplay="true" loop="true" preload="auto">
          <source src="comet/video/video.mp4" type="video/mp4">
            <source src="comet/video/video.webm" type="video/webm">
        </video>
      </div>
          ...
          <div class="boxes clients">
            <div class="row">
              <div class="col-sm-4 col-xs-6 border-right border-bottom">
                <img src="{{ asset('/') }}media/images/clients/{{ $clients->cl1 }}" alt="" data-animated="true" class="client-image">
              </div>
              <div class="col-sm-4 col-xs-6 border-right border-bottom">
                <img src="{{ asset('/') }}media/images/clients/{{ $clients->cl2 }}" alt="" data-animated="true" data-delay="500" class="client-image">
              </div>
              <div class="col-sm-4 col-xs-6 border-bottom">
                <img src="{{ asset('/') }}media/images/clients/{{ $clients->cl3 }}" alt="" data-animated="true" data-delay="1000" class="client-image">
              </div>
              <div class="col-sm-4 col-xs-6 border-right">
                <img src="{{ asset('/') }}media/images/clients/{{ $clients->cl4 }}" alt="" data-animated="true" class="client-image">
              </div>
              <div class="col-sm-4 col-xs-6 border-right">
                <img src="{{ asset('/') }}media/images/clients/{{ $clients->cl5 }}" alt="" data-animated="true" data-delay="500" class="client-image">
              </div>
              <div class="col-sm-4 col-xs-6">
                <img src="{{ asset('/') }}media/images/clients/{{ $clients->cl6 }}" alt="" data-animated="true" data-delay="1000" class="client-image">
              </div>
            </div>
            <!-- end of row-->
          </div>
          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <div class="footer-social">
                <ul>
                  <li>
                    <a target="_blank" href="{{ $socials->fb }}"><i class="ti-facebook"></i></a>
                  </li>
                  <li>
                    <a target="_blank" href="{{ $socials->tw }}"><i class="ti-twitter-alt"></i></a>
                  </li>
                  <li>
                    <a target="_blank" href="{{ $socials->link }}"><i class="ti-linkedin"></i></a>
                  </li>
                  <li>
                    <a target="_blank" href="{{ $socials->ins }}"><i class="ti-instagram"></i></a>
                  </li>
                  <li>
                    <a target="_blank" href="{{ $socials->dri }}"><i class="ti-dribbble"></i></a>
                  </li>
                </ul>
              </div>
            </div>
