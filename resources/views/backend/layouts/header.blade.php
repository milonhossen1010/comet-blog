    ...
    <div class="main-header-right row">
        <div class="main-header-left d-lg-none">
            <div class="logo-wrapper">
                <a href="index.html"><img class="blur-up lazyloaded" src="{{ asset('/') }}media/images/logo{{ $logos->d_logo }}" alt=""></a>
            </div>
        </div>
            ...
            <ul class="nav-menus">
                ...
                <li class="onhover-dropdown">
                    <div class="media align-items-center"><img
                            ...
                            src="{{ asset('/') }}media/images/users/{{ Auth::user()->img }}" alt="header-user">
