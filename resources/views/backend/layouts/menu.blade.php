...
<div class="page-sidebar">
	...
	<div class="sidebar custom-scrollbar">
		...
		<ul class="sidebar-menu">
			...
			<li class="{{ ($route=='project.category.index' || $route == 'project.store') ? 'active' : ''}} {{ (Auth::user()->role!=='administrator') ? 'd-none' : ''  }}">
				<a class="sidebar-header" href="">
					<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-tag"><path d="M20.59 13.41l-7.17 7.17a2 2 0 0 1-2.83 0L2 12V2h10l8.59 8.59a2 2 0 0 1 0 2.82z"></path><line x1="7" y1="7" x2="7" y2="7"></line></svg>
					<span>Projects</span><i class="fa fa-angle-right pull-right"></i>
				</a>
				<ul class="sidebar-submenu">
					
					<li class="{{ ($route=='project.store')? 'active' :'' }}"><a class="{{ ($route=='project.store') ? 'active' : '' }}" href="{{ route('project.store') }}"><i class="fa fa-circle"></i>Add Project</a></li>
					<li class="{{ ($route=='project.category.index')? 'active' :'' }}"><a class="{{ ($route=='project.category.index') ? 'active' : '' }}" href="{{ route('project.category.index') }}"><i class="fa fa-circle"></i>Category</a></li>
